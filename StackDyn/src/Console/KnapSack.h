...
public:
    ...
    int MoveBlockBuffers(Stack& arrivalStack, Stack& buffer1, Stack& buffer2, Stack& buffer3, std::list<Block*> blocksb1, std::list<Block*> blocksb2, std::list<Block*> blocksb3, Crane* crane, int timeOfTopBlockb1, int timeOfTopBlockb2, int timeOfTopBlockb3, Block* block);
};
